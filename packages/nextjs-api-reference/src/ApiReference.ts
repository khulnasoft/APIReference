 ...
 *
 * {@link https://github.com/khulnasoft/apireference?tab=readme-ov-file#configuration Configuration}
 *
...
export const ApiReference = (refConfig: ReferenceConfiguration) => {
  ...
  if (!spec?.content && !spec?.url) {
    throw new Error(
      '[@apireference/nextjs-api-reference] You didn’t provide a spec.content or spec.url. Please provide one of these options.',
    )
  }
