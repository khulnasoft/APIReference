...
import { ScalarButton } from '@apireference/components'
import { type ThemeId } from '@apireference/themes'
  ...
  <div class="start custom-scroll">
    ...
    <div class="start-row">
      ...
      <div class="start-section">
        ...
        <a
          class="start-item"
          href="https://github.com/khulnasoft/apireference/tree/main/packages/fastify-api-reference#readme"
          target="_blank">
          <svg
            fill="currentColor"
            height="16"
        ...
        <a
          class="start-item"
          href="https://github.com/khulnasoft/apireference/tree/main#from-a-cdn"
          target="_blank">
          <svg
            fill="currentColor"
            viewBox="0 0 24 24"
        ...
        <a
          class="start-item"
          href="https://github.com/khulnasoft/apireference/tree/main#with-vuejs"
          target="_blank">
          <svg
            height="170"
        ...
        <a
          class="start-item"
          href="https://github.com/khulnasoft/apireference/tree/main#with-react"
          target="_blank">
          <svg
            height="23.3"
            viewBox="0 0 22 23.3"
