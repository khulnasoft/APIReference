...
} from '@apireference/swagger-editor'
import { type ThemeId, ThemeStyles } from '@apireference/themes'
import { FlowModal, useModal } from '@apireference/use-modal'
...
const LazyLoadedSwaggerEditor = defineAsyncComponent(() =>
  import('@apireference/swagger-editor').then((module) => module.SwaggerEditor),
)
