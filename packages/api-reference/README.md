...
[![Version](https://img.shields.io/npm/v/%40scalar/api-reference)](https://www.npmjs.com/package/@apireference/api-reference)
[![Downloads](https://img.shields.io/npm/dm/%40scalar/api-reference)](https://www.npmjs.com/package/@apireference/api-reference)
[![Hits on jsdelivr](https://img.shields.io/jsdelivr/npm/hm/%40scalar%2Fapi-reference)](https://www.jsdelivr.com/package/npm/@apireference/api-reference)
[![License](https://img.shields.io/npm/l/%40scalar%2Fapi-reference)](https://www.npmjs.com/package/@apireference/api-reference)
...
You can even [mount the component in React](https://github.com/khulnasoft/apireference/blob/main/examples/react/src/App.tsx).
...
You can preprocess specs with `@apireference/swagger-parser` and directly pass the result.
...
ℹ️ You can use [@apireference/api-client-proxy](https://github.com/khulnasoft/apireference/tree/main/packages/api-client-proxy) to host your own proxy or you can just use ours:
