...
[![CI](https://github.com/khulnasoft/apireference/actions/workflows/ci.yml/badge.svg)](https://github.com/khulnasoft/apireference/actions/workflows/ci.yml)
[![Release](https://github.com/khulnasoft/apireference/actions/workflows/release.yml/badge.svg)](https://github.com/khulnasoft/apireference/actions/workflows/release.yml)
[![Contributors](https://img.shields.io/github/contributors/khulnasoft/apireference)](https://github.com/khulnasoft/apireference/graphs/contributors)
[![GitHub License](https://img.shields.io/github/license/khulnasoft/apireference)](https://github.com/khulnasoft/apireference/blob/main/LICENSE)
...
<html>
  ...
  <body>
    ...
    <script src="https://cdn.jsdelivr.net/npm/@apireference/api-reference"></script>
  </body>
</html>
```
...
```bash
npm install @apireference/api-reference
```
...
import { ApiReference } from '@apireference/api-reference'
</script>
...
You can [pass props to customize the API reference](https://github.com/khulnasoft/apireference/tree/main/packages/api-reference).
...
```ts
import { ApiReference as VueComponent } from '@apireference/api-reference'
...
Read more: [@apireference/nextjs-api-reference](https://github.com/khulnasoft/apireference/tree/main/packages/nextjs-api-reference)
...
Read more: [@apireference/fastify-api-reference](https://github.com/khulnasoft/apireference/tree/main/packages/fastify-api-reference)
...
Read more: [@apireference/hono-api-reference](https://github.com/khulnasoft/apireference/tree/main/packages/hono-api-reference)
...
Read more: [@apireference/express-api-reference](https://github.com/khulnasoft/apireference/tree/main/packages/express-api-reference)
...
Read more: [@apireference/nestjs-api-reference](https://github.com/khulnasoft/apireference/tree/main/packages/nestjs-api-reference)
...
We wrote a [detailed integration guide for Laravel Scribe](https://github.com/khulnasoft/apireference/tree/main/documentation/laravel-scribe.md), too.
...
- `spec.preparsedContent`: Preprocess specs with `@apireference/swagger-parser` and directly pass the result.
...
For detailed information on how to use these options, refer to the [Configuration Section](https://github.com/khulnasoft/apireference/blob/main/packages/api-reference/README.md/#configuration).
...
![layouts](https://github.com/khulnasoft/apireference/assets/6374090/a28b89e0-8d3b-477f-a02f-bcf39f7830f0)
...
We’re using the `default-` prefix for our variables to not overwrite your variables. You can [use all variables without a prefix](https://github.com/khulnasoft/apireference/blob/main/packages/themes/src/base.css).
...
![basic-scalar-variables](https://github.com/khulnasoft/apireference/assets/6201407/63524321-66d2-44d0-8509-3db7e045a315)
...
![scalar-sidebar-variables](https://github.com/khulnasoft/apireference/assets/6201407/2c363cbc-f06f-4ad3-b44f-05cee8c95a8b)
...
| Package                                                                                                                    | Description                                 |
| -------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------- |
| [@apireference/api-client-proxy](https://github.com/khulnasoft/apireference/tree/main/packages/api-client-proxy)           | API request proxy                           |
| [@apireference/api-client](https://github.com/khulnasoft/apireference/tree/main/packages/api-client)                       | API testing client                          |
| [@apireference/api-reference](https://github.com/khulnasoft/apireference/tree/main/packages/api-reference)                 | beautiful API references                    |
| [@apireference/cli](https://github.com/khulnasoft/cli/tree/main/packages/cli)                                              | CLI to work with OpenAPI files              |
| [@apireference/echo-server](https://github.com/khulnasoft/apireference/tree/main/packages/echo-server)                     | a server that replies with the request data |
| [@apireference/express-api-reference](https://github.com/khulnasoft/apireference/tree/main/packages/express-api-reference) | Express plugin                              |
| [@apireference/fastify-api-reference](https://github.com/khulnasoft/apireference/tree/main/packages/fastify-api-reference) | Fastify plugin                              |
| [@apireference/hono-api-reference](https://github.com/khulnasoft/apireference/tree/main/packages/hono-api-reference)       | Hono middleware                             |
| [@apireference/nestjs-api-reference](https://github.com/khulnasoft/apireference/tree/main/packages/nestjs-api-reference)   | NestJS middleware                           |
| [@apireference/nextjs-api-reference](https://github.com/khulnasoft/apireference/tree/main/packages/nestjs-api-reference)   | Next.js adapter                             |
| [@apireference/swagger-editor](https://github.com/khulnasoft/apireference/tree/main/packages/swagger-editor)               | editor tailored to write OpenAPI files      |
| [@apireference/swagger-parser](https://github.com/khulnasoft/apireference/tree/main/packages/swagger-parser)               | parse OpenAPI files                         |
...
Contributions are welcome! Read [`CONTRIBUTING`](https://github.com/khulnasoft/apireference/blob/main/CONTRIBUTING).

## License

The source code in this repository is licensed under [MIT](https://github.com/khulnasoft/apireference/blob/main/LICENSE).
